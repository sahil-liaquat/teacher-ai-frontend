    ...
    <div className="mx-auto grid w-full max-w-[1480px] gap-4 px-0 2xl:px-4 animate-pulse">
        ...
        {[0, 1].map((i) => (
          ...
          >
            <div className="flex h-full flex-col justify-between">
              ...
              <div className="h-10 w-36 rounded-card bg-slate-200 mt-4" />
            </div>
          </div>
        ))}
      </section>
      ...
      <section className="mx-auto grid w-full max-w-[1240px] items-stretch gap-4 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="h-full rounded-[18px] border border-white/70 bg-white/80 p-4 shadow-[0_14px_34px_rgba(15,23,42,0.07)] backdrop-blur-sm space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="h-8 w-16 rounded-card bg-slate-200" />
          </div>
          <div className="space-y-3">
            {[0, 1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center gap-3 rounded-card p-2 bg-slate-50/50">
                <div className="h-10 w-10 shrink-0 rounded-card bg-slate-200" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-32 rounded bg-slate-200" />
                  <div className="h-3 w-24 rounded bg-slate-200" />
                </div>
                <div className="h-6 w-16 rounded-control bg-slate-200" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex h-full flex-col rounded-[18px] border border-white/70 bg-white/80 p-4 shadow-[0_14px_34px_rgba(15,23,42,0.07)] backdrop-blur-sm space-y-4">
          ...
          <div className="grid flex-1 gap-4 lg:grid-cols-[0.85fr_1.15fr]">
            {/* Donut section */}
            <div className="rounded-card border border-slate-100 bg-gradient-to-br from-slate-50 to-white p-4 flex flex-col space-y-3">
          ...
          <div className="grid gap-3 lg:grid-cols-2">
            {[0, 1].map((i) => (
              <div key={i} className="flex min-h-[88px] items-center gap-3 rounded-card border border-slate-100 bg-slate-50/50 p-3">
                <div className="h-10 w-10 shrink-0 rounded-control bg-slate-200" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-20 rounded bg-slate-200" />
      ...
      <section className="mx-auto w-full max-w-[1240px] rounded-[18px] border border-white/70 bg-white/80 p-4 shadow-[0_14px_34px_rgba(15,23,42,0.07)] backdrop-blur-sm space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-8 w-24 rounded-card bg-slate-200" />
        </div>
        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
          {[0, 1, 2, 3, 4].map((i) => (
            <div key={i} className="flex min-h-[82px] items-center gap-3 rounded-card border border-slate-100 bg-slate-50/50 p-3">
              <div className="h-10 w-10 shrink-0 rounded-card bg-slate-200" />
              <div className="flex-1 space-y-2">
                <div className="h-4 w-20 rounded bg-slate-200" />
