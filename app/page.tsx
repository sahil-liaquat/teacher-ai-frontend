  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-blue-100">
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-blue-600 shadow-md">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/signup"><Button className="bg-gradient-to-r from-blue-600 to-blue-600">Signup</Button></Link>
          </div>
        </div>
      </header>
      ...
      <section className="relative flex min-h-[82vh] items-center overflow-hidden py-24">
        ...
        <div className="absolute bottom-20 right-10 h-96 w-96 rounded-full bg-blue-400/20 blur-3xl" />
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-[1.04fr_0.96fr]">
          <div className="animate-fade-in-up">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <Link href="/signup">
                <Button className="h-12 px-8 bg-gradient-to-r from-blue-600 to-blue-600 shadow-lg">
                  Get Started
          ...
          <Card className="relative border-slate-200 bg-white/95 shadow-xl backdrop-blur-sm">
            <CardHeader>
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-blue-600 shadow-md">
            ...
            <CardContent className="grid gap-3">
              {["Select textbook", "Choose chapter", "Generate resource", "Save and export"].map((step, index) => (
                <div key={step} className="premium-hover-sm flex items-center gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-blue-600 text-sm font-bold text-white shrink-0">
                    {index + 1}
                  </div>
              ...
              <Card key={tool.title} className="group border-slate-200 bg-white/95 shadow-md backdrop-blur-sm">
                <CardHeader>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <span className="rounded-full bg-blue-100 px-2 py-1 text-xs font-semibold text-blue-700">{tool.badge}</span>
                  </div>
                </CardHeader>
                <CardContent>
