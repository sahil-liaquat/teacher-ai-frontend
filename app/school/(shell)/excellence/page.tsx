...
/**
 * Excellence overview — the diagnosis surface.
 *
 ...
 */
export default function ExcellenceOverviewPage() {
  return (
    <ProductPage>
      <PageHeading
        eyebrow="School Excellence"
        title="Excellence overview"
        description="Where this school is strong, where it is weak, and the evidence behind both."
      />
      <FoundationNotice>The excellence domain is defined but no review has been run. Scores appear once a framework is published and a review is scored — never before.</FoundationNotice>
      <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6">
        ...
        <ol className="mt-5 flex flex-wrap items-center gap-2 text-sm font-semibold">
          {["Academic delivery", "Insights metrics", "Indicator score", "Domain score", "Excellence Score"].map((step, index, all) => (
